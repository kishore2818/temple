...
// Import all temple images
import templeImage1 from '../photos/gallery-1.jpg';
import templeImage2 from '../photos/gallery-2.jpg';
import templeImage3 from '../photos/gallery-3.jpg';
import templeImage4 from '../photos/gallery-4.jpg';
import templeImage5 from '../photos/gallery-5.png';
import templeImage6 from '../photos/gallery-6.jpg';
import templeImage7 from '../photos/gallery-7.jpg';
import templeImage8 from '../photos/gallery-8.png';
import templeImage9 from '../photos/gallery-9.png';
...
// Temple images array with proper descriptions
const templeImages = [
  { 
    src: templeImage1, 
    altEn: 'Temple Main Entrance', 
    altHi: 'मंदिर का मुख्य प्रवेश द्वार',
    descriptionEn: 'Grand entrance with traditional architecture',
    descriptionHi: 'पारंपरिक वास्तुकला के साथ भव्य प्रवेश द्वार'
  },
  { 
    src: templeImage2, 
    altEn: 'Main Sanctum Sanctorum', 
    altHi: 'मुख्य गर्भगृह',
    descriptionEn: 'Sacred inner chamber of the deity',
    descriptionHi: 'देवता का पवित्र आंतरिक कक्ष'
  },
  { 
    src: templeImage3, 
    altEn: 'Temple Tower View', 
    altHi: 'मंदिर शिखर दृश्य',
    descriptionEn: 'Magnificent temple spire reaching skywards',
    descriptionHi: 'आकाश की ओर बढ़ता भव्य मंदिर शिखर'
  },
  { 
    src: templeImage4, 
    altEn: 'Prayer Hall Interior', 
    altHi: 'प्रार्थना कक्ष आंतरिक भाग',
    descriptionEn: 'Spacious hall for devotees prayers',
    descriptionHi: 'भक्तों की प्रार्थना के लिए विशाल कक्ष'
  },
  { 
    src: templeImage5, 
    altEn: 'Ancient Temple Carvings', 
    altHi: 'प्राचीन मंदिर नक्काशी',
    descriptionEn: 'Intricate stone carvings on walls',
    descriptionHi: 'दीवारों पर जटिल पत्थर की नक्काशी'
  },
  { 
    src: templeImage6, 
    altEn: 'Temple Courtyard', 
    altHi: 'मंदिर प्रांगण',
    descriptionEn: 'Peaceful courtyard for meditation',
    descriptionHi: 'ध्यान के लिए शांतिपूर्ण प्रांगण'
  },
  { 
    src: templeImage7, 
    altEn: 'Festival Decoration', 
    altHi: 'त्योहार सजावट',
    descriptionEn: 'Temple adorned during special occasions',
    descriptionHi: 'विशेष अवसरों पर सजा मंदिर'
  },
  { 
    src: templeImage8, 
    altEn: 'Evening Aarti View', 
    altHi: 'संध्या आरती दृश्य',
    descriptionEn: 'Evening prayer ceremony with lamps',
    descriptionHi: 'दीपों के साथ संध्या प्रार्थना समारोह'
  },
  { 
    src: templeImage9, 
    altEn: 'Temple Garden', 
    altHi: 'मंदिर उद्यान',
    descriptionEn: 'Beautiful gardens surrounding temple',
    descriptionHi: 'मंदिर को घेरने वाले सुंदर उद्यान'
  }
...
const HeritageInfo: React.FC<HeritageInfoProps> = ({ language }) => {
  ...
  const getImageAltText = (image: typeof templeImages[0]) => {
    return language.code === 'hi' ? image.altHi : image.altEn;
  };

  const getImageDescription = (image: typeof templeImages[0]) => {
    return language.code === 'hi' ? image.descriptionHi : image.descriptionEn;
  };
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-6">
                  <div className="bg-yellow-50 border-l-4 border-yellow-500 p-6 rounded-lg">
                    ...
                    <p className="text-yellow-700 leading-relaxed">
                      {language.code === 'hi' 
                        ? 'यह पवित्र मंदिर 12वीं शताब्दी में स्थापित किया गया था। महान राजा देवराज द्वारा निर्मित, यह मंदिर सदियों से भक्तों की आस्था का केंद्र रहा है।'
                        : 'Somnath Temple, located in Prabhas Patan near Veraval in Gujarat, is one of the twelve Jyotirlinga shrines of Lord Shiva. According to legend, the temple was first built by the Moon God (Soma) in gold, followed by subsequent constructions in silver, wood, and stone. Its origins are steeped in ancient mythology, dating back thousands of years, making it a symbol of India’s rich spiritual heritage. Historical records suggest that it has been a prominent place of worship since the early centuries of the Common Era.'
                      }
                    </p>
                  </div>
                  ...
                  <div className="bg-red-50 border-l-4 border-red-500 p-6 rounded-lg">
                    ...
                    <p className="text-red-700 leading-relaxed">
                      {language.code === 'hi'
                        ? 'मंदिर अपनी चमत्कारिक शक्तियों के लिए प्रसिद्ध है। यहाँ के मुख्य देवता भगवान शिव हैं, जो भक्तों की मनोकामनाएं पूर्ण करते हैं।'
                        : 'Somnath Temple is one of the twelve Jyotirlingas, making it a vital pilgrimage site for Hindus, where devotees seek spiritual purification and blessings. Beyond its religious importance, it stands as a symbol of India’s cultural resilience and enduring devotion, representing centuries of faith, heritage, and architectural excellence. Its location by the Arabian Sea, along with its intricate carvings and majestic spires, also makes it a major cultural and tourist landmark.'
                      }
                    </p>
                  </div>
                  ...
                  <div className="bg-green-50 border-l-4 border-green-500 p-6 rounded-lg">
                    ...
                    <p className="text-green-700 leading-relaxed">
                      {language.code === 'hi'
                        ? 'मंदिर का अंतिम बड़ा नवीनीकरण 2010 में किया गया था। आधुनिक सुविधाओं के साथ पारंपरिक वास्तुकला को संरक्षित किया गया है।'
                        : 'The Somnath Temple faced repeated destruction over the centuries due to invasions, yet it was rebuilt each time by devoted rulers and communities, reflecting resilience and faith. The present structure was reconstructed in 1951 under Sardar Vallabhbhai Patel in the Chalukya style of architecture, using pink sandstone from Rajasthan. The design combines traditional craftsmanship with grandeur, strength, and intricate detailing. Today, the temple stands as a symbol of India’s cultural revival, enduring devotion, and architectural brilliance, attracting pilgrims and visitors from across the world'
                      }
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="rounded-lg overflow-hidden shadow-lg">
                    <img 
                      src={templeImage5} 
                      alt={getImageAltText(templeImages[0])}
                  ...
                  <div className="bg-gray-50 rounded-lg p-6">
                    ...
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-center space-x-2">
                        <Clock size={16} className="text-red-600" />
                        <span>{language.code === 'hi' ? 'स्थापना: 12वीं शताब्दी' : 'Founded: built by Moon God, 4th–5th century CE) '}</span>
                      </li>
                      <li className="flex items-center space-x-2">
                        <MapPin size={16} className="text-red-600" />
                        <span>{language.code === 'hi' ? 'शैली: द्रविड़ वास्तुकला' : 'Style: Chalukya (traditional Indian temple architecture)'}</span>
                      </li>
                      <li className="flex items-center space-x-2">
                        <Star size={16} className="text-red-600" />
                        <span>{language.code === 'hi' ? 'मुख्य देवता: भगवान शिव' : 'Main Deity: Lord Shiva'}</span>
                      ...
                      <li className="flex items-center space-x-2">
                        <Clock size={16} className="text-red-600" />
                        <span>{language.code === 'hi' ? 'स्थापना: 12वीं शताब्दी' : 'Festivals: Mahashivratri, Shravan Month celebrations'}</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  <div className="rounded-lg overflow-hidden shadow-lg">
                    <img 
                      src={templeImage5} 
                      alt={getImageAltText(templeImages[4])}
                      className="w-full h-64 object-cover hover:scale-105 transition-transform duration-300 cursor-pointer"
                      onClick={() => setSelectedImage({
                        src: templeImage5,
                        alt: getImageAltText(templeImages[4])
                  ...
                  <p className="text-center text-gray-600 text-sm">
                    {getImageDescription(templeImages[4])}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  <div className="rounded-lg overflow-hidden shadow-lg">
                    <img 
                      src={templeImage9} 
                      alt={getImageAltText(templeImages[6])}
                      className="w-full h-50 object-cover hover:scale-105 transition-transform duration-300 cursor-pointer"
                      onClick={() => setSelectedImage({
                        src: templeImage9,
                        alt: getImageAltText(templeImages[6])
                      })}
                  ...
                  >
                    ...
                    <div className="mt-3 text-center">
                      <p className="font-medium text-gray-800">
                        {language.code === 'hi' ? `मंदिर छवि-${index + 1}` : `Temple Image-${index + 1}`}
                      </p>
